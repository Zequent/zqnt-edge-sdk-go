...
import (
	context "context"
	proto "github.com/Zequent/zqnt-edge-sdk-go/gen/execution/contracts/proto"
...
const (
	...
	MissionAutonomyService_GetApplicationEnvironments_FullMethodName = "/zqnt.MissionAutonomyService/GetApplicationEnvironments"
	MissionAutonomyService_PromoteApplicationVersion_FullMethodName  = "/zqnt.MissionAutonomyService/PromoteApplicationVersion"
...
type MissionAutonomyServiceClient interface {
	...
	GetApplicationEnvironments(ctx context.Context, in *proto.GetApplicationEnvironmentsRequest, opts ...grpc.CallOption) (*proto.ApplicationEnvironmentsResponse, error)
	PromoteApplicationVersion(ctx context.Context, in *proto.PromoteApplicationVersionRequest, opts ...grpc.CallOption) (*proto.ApplicationEnvironmentsResponse, error)
...
func (c *missionAutonomyServiceClient) GetApplicationEnvironments(ctx context.Context, in *proto.GetApplicationEnvironmentsRequest, opts ...grpc.CallOption) (*proto.ApplicationEnvironmentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.ApplicationEnvironmentsResponse)
	err := c.cc.Invoke(ctx, MissionAutonomyService_GetApplicationEnvironments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *missionAutonomyServiceClient) PromoteApplicationVersion(ctx context.Context, in *proto.PromoteApplicationVersionRequest, opts ...grpc.CallOption) (*proto.ApplicationEnvironmentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.ApplicationEnvironmentsResponse)
	err := c.cc.Invoke(ctx, MissionAutonomyService_PromoteApplicationVersion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MissionAutonomyServiceServer interface {
	...
	GetApplicationEnvironments(context.Context, *proto.GetApplicationEnvironmentsRequest) (*proto.ApplicationEnvironmentsResponse, error)
	PromoteApplicationVersion(context.Context, *proto.PromoteApplicationVersionRequest) (*proto.ApplicationEnvironmentsResponse, error)
	// Unified execution API. ExecuteSkill is the low-friction entry point for simple commands.
...
func (UnimplementedMissionAutonomyServiceServer) GetApplicationEnvironments(context.Context, *proto.GetApplicationEnvironmentsRequest) (*proto.ApplicationEnvironmentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetApplicationEnvironments not implemented")
}
func (UnimplementedMissionAutonomyServiceServer) PromoteApplicationVersion(context.Context, *proto.PromoteApplicationVersionRequest) (*proto.ApplicationEnvironmentsResponse, error) {
...
func _MissionAutonomyService_GetApplicationEnvironments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(proto.GetApplicationEnvironmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MissionAutonomyServiceServer).GetApplicationEnvironments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MissionAutonomyService_GetApplicationEnvironments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MissionAutonomyServiceServer).GetApplicationEnvironments(ctx, req.(*proto.GetApplicationEnvironmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MissionAutonomyService_PromoteApplicationVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(proto.PromoteApplicationVersionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MissionAutonomyServiceServer).PromoteApplicationVersion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MissionAutonomyService_PromoteApplicationVersion_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MissionAutonomyServiceServer).PromoteApplicationVersion(ctx, req.(*proto.PromoteApplicationVersionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MissionAutonomyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MissionAutonomyService_GetApplicationEnvironments_Handler,
		},
		{
			MethodName: "PromoteApplicationVersion",
			Handler:    _MissionAutonomyService_PromoteApplicationVersion_Handler,
		},
		{
